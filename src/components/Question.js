    ...
    return (
        <div>
             ...
             <div  className="containerQquestion">
               ...
               <ul className ="ulFaq">
                 <li className="liFaq"><h2>•	What should I bring to my consultation or appointment?</h2>
                 <p className="pFaq">Always bring your state issued identification card. Also bring any reference pictures you might have.</p>
                 </li>
                 <br/>

                 <li className="liFaq"><h2>•	How old do I have to be to get tattooed?</h2>
                 <p className="pFaq">
                 ...
                 <li className="liFaq"><h2>•	How old do I have to be to get pierced?</h2>
                 <p className="pFaq">We currently do not offer piercing services, but carry a variety of jewelry for sale. It is against the law 
                 ...
                 <li className="liFaq"><h2>•	How are prices determined?</h2>
                 <p className="pFaq">Most artists have a set hourly price, this varies from artist to artist. Depending on the piece, 
                 ...
                 <li className="liFaq"><h2>•	Do you take walk-ins?</h2>
                 <p className="pFaq">Although appointments are recommended, we DO take walk-ins. </p>
                 </li>
                 <br/>

                 <li className="liFaq"><h2>•	If I take a design or reference, will you tattoo that exact design?</h2>
                 <p className="pFaq">It depends on the reference - if it is a portrait, of course! Given that we are an all custom studio, 
                 ...
                 <li className="liFaq"><h2>•	Is there a cancellation policy?</h2>
                 <p className="pFaq">Yes, any cancellation or re-schedule must be done at least 48 hours prior to your original appointment. 
